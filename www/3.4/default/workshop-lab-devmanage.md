...
{% highlight csh %}
$ oc env dc/dc-metro-map -e WMATA_API_KEY=9b0560bbc3cf4ac4bc4599dc0534a386
{% endhighlight %}
...
<blockquote>
Add an environment variable with the name <strong>WMATA_API_KEY</strong> and a value of <strong>9b0560bbc3cf4ac4bc4599dc0534a386</strong>
</blockquote>
...
That should return the <strong>WMATA_API_KEY=9b0560bbc3cf4ac4bc4599dc0534a386</strong> matching the value that we set in the deployment config.
